  ...
  def list_graph_example
    [
      {"gfuri"=>'http://localhost:5125',
       ...
       "graph_name"=>"app%20name%2Fhost%20name%2F%3C1sec%20count",
       "id"=>1},
      {"gfuri"=>'http://localhost:5125',
       "path"=>"app name/host name/<2sec count",
       "service_name"=>"mgclient",
       "section_name"=>"mgclient",
       "graph_name"=>"app+name%2Fhost+name%2F%3C2sec+count",
        "id"=>2},
    ]
  end
...
shared_context "stub_get_complex" do
  def complex_example
    {"gfuri"=>"http://localhost:5125",
     ...
     "service_name"=>"mgclient",
     "section_name"=>"mgclient",
     "graph_name"=>"app%20name%2Fhost%20name%2Fcomplex%20graph%20test",
     "number"=>0,
     "complex"=>true,
